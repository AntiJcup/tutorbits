...
export class EditCommentComponent implements OnInit {
  ...
  @Output()
  public commentUpdated = new EventEmitter();

  @Output()
  public commentUpdateCancel = new EventEmitter();
  ...
  async submit(model: UpdateComment) {
    ...
    try {
      ...
      this.commentUpdated.next(res.data as ViewComment);
    } catch (err) {
