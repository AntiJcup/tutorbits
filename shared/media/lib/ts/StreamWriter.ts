...
export abstract class StreamWriter {
    ...
    public abstract async FinishUpload(projectId: string, recordingId: string, parts: Array<Part>): Promise<boolean>;
    public abstract async CheckStatus(projectId: string): Promise<string>;
}
